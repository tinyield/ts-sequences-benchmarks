...
import {UnderscoreOperations} from '../../lib/operations/underscore-operations';
import * as _ from 'underscore';

function getCountriesPairedWithArtists(): _._Chain<Pair<Country, _._Chain<Artist, Artist[]>>, Pair<Country, _._Chain<Artist, Artist[]>>[]> {
...
function getCountriesPairedWithTracks(): _._Chain<Pair<Country, _._Chain<Track, Track[]>>, Pair<Country, _._Chain<Track, Track[]>>[]> {
...
describe('UnderscoreOperations', () => {
    let operations: UnderscoreOperations;
    let numbers: number[];
    ...
    beforeEach(() => {
        ...
        artists = getArtists();
        tracks = getTracks();
        operations = new UnderscoreOperations();
    });
    ...
    describe('when "zipTopArtistAndTrackByCountry" is called', () => {
        ...
        beforeEach(() => {
            ...
            actual = operations.zipTopArtistAndTrackByCountry(getCountriesPairedWithArtists(), getCountriesPairedWithTracks()).value();
        });
    ...
    describe('when "zipPrimeWithValue" is called', () => {
        ...
        beforeEach(() => {
            ...
            actual = operations.zipPrimeWithValue(_.chain(numbers), _.chain(numbers.map(n => new Value(n)))).value();
        });
